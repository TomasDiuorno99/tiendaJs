...
const botonSeguir = document.getElementById("seguir-comprando")
...
stockProductos.forEach((producto) => {
    ...
    <button id="agregar${producto.id}" class="boton-agregar"> Añadir al carrito <i class fas-fa-shopping-cart></button>
    `
